...
if __name__ == "__main__":
    # Use Excel file
    excel_file = "/Users/wang/Documents/Programming/vscode programs/CS 124 Honors/FA25-Group16/Backend/nutrition-scraper/all_dining_halls_20251118_134833.xlsx"

    planner = MealPlanner(excel_file=excel_file)

    # Example 1: Lunch at ISR, 600 calories
    ...
    # Example 2: Auto-detect meal type based on current time
    print("\n" + "="*60)
    print("Auto-detected meal:")
    print("="*60)
    meal_plan2 = planner.create_meal_plan(
        target_calories=500,
        dining_hall="ISR"
    )

    planner.print_meal_plan(meal_plan2)
